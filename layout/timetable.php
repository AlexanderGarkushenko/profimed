...
<head>
    ...
    <link rel="stylesheet" href="../css/tametable.css">
...
<body>
    <div class="parent">
        ...
        <div class="title">
            <h1 class="timetb">Расписание</h1>
            <div class="home-tb">
                <a class="homes" href="main_page/main_page.html">Домашняя</a>
                <p class="stick">/</p>
                <p class="timetb-p">Расписание</p>
            </div>
        </div>
    </div>
    <!-- Конец панели -->
    <div class="backg1">
        <div>
            <img src="../image/timetable_promo.jpg">
        </div>
        <div class="per_time-div">
            <div class="per_time">
                <h1 class="timet_h1">Расписание</h1>
                <h3 class="timet_h3">Выберите идеальное время для следующего визитa</h3>
            </div>
        </div>
    </div>
    <!-- Конец панели -->
